...
public class DishController {
    ...
    public List<DishDto> getDishesByPeriod(
        ...
        return dishService.getDishesByPeriodDto(appUserId, from, to);
    }
    ...
    public List<DishDto> addByText(
        ...
        return dishService.getDishDtoByDescriptionOrNull(appUserId, request.getText());
    }
    ...
    public List<DishDto> addByPhoto(
        ...
        return dishService.processPhotoAndGetListDto(appUserId, request.getBase64Image(), request.getMessage());
    }
    ...
    public List<DishDto> addByVoice(
        ...
        return dishService.processVoiceAndGetListDto(appUserId, request.getBase64Audio(), request.getFormat());
    }
    ...
    @GetMapping("/streak")
    @Operation(summary = "Удалить блюдо", description = "Удаляет блюдо из дневника питания по его ID")
    public int getDishStreakByDays(@Parameter(hidden = true) @AuthenticationPrincipal Long appUserId) {
        return dishService.getCurrentStreak(appUserId);
    }
