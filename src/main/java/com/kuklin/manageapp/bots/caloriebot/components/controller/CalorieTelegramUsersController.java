...
public class CalorieTelegramUsersController {
    ...
    @GetMapping
    public TelegramUser getTelegramUserByTelegramId(@RequestParam Long tgId) {
        return telegramUserService.getTelegramUserByTelegramIdAndBotIdentifierOrNull(tgId, BotIdentifier.CALORIE_BOT);
    }
